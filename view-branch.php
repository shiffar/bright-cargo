    ...
    <body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
                ...
                <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                    ...
                    <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                        ...
                        ?>      
                                            <script>
                                                <?php if(!$access_denied): ?>
                                                    ...
                                                    <?php if ($can_add || $can_add_delete || $can_add_edit || $can_add_edit_delete ) : ?>
                                                        document.write('<a href="#"class="btn btn-icon btn-active-color-primary flex-shrink-0 bg-body w-40px h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#addBranchModal"><i class="ki-duotone ki-abstract-10 fs-1"><span class="path1"></span><span class="path2"></span></i></a>');
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </script>
                                            

                                            <div class="modal fade" tabindex="-1" id="addBranchModal">
                                                <div class="modal-dialog modal-dialog-centered mw-900px">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="branchAddForm">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="c_branch_name">Name</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="c_branch_name" name="c_branch_name" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="c_branch_location">Location</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="c_branch_location" name="c_branch_location">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="c_branch_email">Email</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="c_branch_email" name="c_branch_email">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="c_branch_contact">Contact</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="c_branch_contact" name="c_branch_contact">
                                                                        </div>
                                                                    </div>
                                                                    
                                                                </div>
                                                                <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="saveBranch">
                                            ...
                                            <div class="modal fade" tabindex="-1" id="updateBranchModal">
                                                <div class="modal-dialog modal-dialog-centered mw-900px">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h3 class="modal-title">Branch</h3>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="branchUpdateForm">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="ec_branch_name">Name</label>
                                                                            <input type="hidden" class="form-control form-control-lg form-control-solid" id="eid" name="eid" required>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="ec_branch_name" name="ec_branch_name" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="ec_branch_location">Location</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="ec_branch_location" name="ec_branch_location">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="ec_branch_email">Email</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="ec_branch_email" name="ec_branch_email">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="ec_branch_contact">Contact</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="ec_branch_contact" name="ec_branch_contact">
                                                                        </div>
                                                                    </div>
                                                                    
                                                                </div>
                                                                <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="updateBranch">
                                                                            <i class="ki-duotone ki-add-folder fs-1"><span class="path1"></span><span class="path2"></span></i>
                                                                            Save changes
                                                                        </a>
                                                                        <a href="#" class="btn btn-active-icon-dark btn-text-dark"  data-bs-dismiss="modal">
                                        ...
                                        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                            ...
                                            <div class="p-0">
                                                <div class="pt-5 pb-10">
                                                    <table id="branchTable" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                        <thead>
        ...
        <script>
            $(document).ready(function() {
                ...
                "columns": [
                    { "data": "c_branch_name" },
                    { "data": "c_branch_location" },
                    { "data": "c_branch_email" },
                    { "data": "c_branch_contact" },
                    {
                        "data": null,
                        "render": function(data, type, full, meta) {
                                ...
                                if (<?php echo $can_edit || $can_add_edit || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-primary btn-text-primary editBranch" data-id="${data.company_branch_id}"><i class="ki-duotone ki-notepad-edit fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                                ...
                                if (<?php echo $can_delete || $can_add_delete || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-danger btn-text-danger deleteBranch" data-id="${data.company_branch_id}"><i class="ki-duotone ki-delete-folder fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                ...
                $("#saveBranch").click(function() {
                    $.post("code-branch.php", $("#branchAddForm").serialize() + '&action=insert', function(response) {
                ...
                // Edit Location
                $('#branchTable tbody').on('click', '.editBranch', function() {
                    var company_branch_id = $(this).data("id");
                    $.post("code-branch.php", { action: 'edit', company_branch_id: company_branch_id }, function(data) {
                        // Populate modal with location data for editing
                        $('#updateBranchModal').modal('show');
                        $('#eid').val(data.company_branch_id);
                        $('#ec_branch_name').val(data.c_branch_name);
                        $('#ec_branch_location').val(data.c_branch_location);
                        $('#ec_branch_email').val(data.c_branch_email);
                        $('#ec_branch_contact').val(data.c_branch_contact);
                    }, 'json');
                });

                // Update Location
                $("#updateBranch").click(function() {
                    $.post("code-branch.php", $("#branchUpdateForm").serialize() + '&action=update', function(response) {
                ...
                // Delete Agent
                $('#branchTable tbody').on('click', '.deleteBranch', function() {
                    var company_branch_id = $(this).data("id");
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.post("code-branch.php", { action: 'delete', company_branch_id: company_branch_id }, function(response) {
                                Swal.fire(
                                    'Deleted!',
