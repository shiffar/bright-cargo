                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="login_form">
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Email" name="da_email" autocomplete="off" class="form-control bg-transparent"/> 
                                    <!--end::Email-->
                                </div>
                                ...
                                <div class="fv-row mb-3">    
                                    <!--begin::Password-->
                                    <input type="password" placeholder="Password" name="da_pass" autocomplete="off" class="form-control bg-transparent"/>
                                    <!--end::Password-->
                                </div>
                                <!--end::Wrapper-->    
                                ...
                                <div class="d-grid mb-10">
                                    <button type="submit" id="loginBtn" class="btn btn-primary" value="delivery_agent">
        ...
        <script>
            $(document).ready(function(){
                $('#login_form').submit(function(event){
                    ...
                    // AJAX request
                    $.ajax({
                        url: 'code-da-login.php', // PHP script for handling login
                        type: 'POST',
                        data: formData,
                        beforeSend: function(){
                        ...
                        success: function(response){
                            if(response == 'success'){
                                ...
                                if(role === 'delivery_agent') {
                                    window.location.href = '<?php echo $url; ?>agent-dashboard.php'; // Redirect customer to cindex.php
                                }
                            } else {
                ...
                $('#loginBtn').click(function() {
                    $('#loginBtn').data('role', 'delivery_agent');
                });
            });
