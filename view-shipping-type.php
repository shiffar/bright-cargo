<?php $title = 'shipped - type'; // Default title?>
<!DOCTYPE html>
    ...
    <body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
                ...
                <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                    ...
                    <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                        ...
                        ?>      
                                            <script>
                                                <?php if(!$access_denied): ?>
                                                    ...
                                                    <?php if ($can_add || $can_add_delete || $can_add_edit || $can_add_edit_delete ) : ?>
                                                        document.write('<a href="#"class="btn btn-icon btn-active-color-primary flex-shrink-0 bg-body w-40px h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#addShippingTypeModal"><i class="ki-duotone ki-abstract-10 fs-1"><span class="path1"></span><span class="path2"></span></i></a>');
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </script>
                                            

                                            <div class="modal fade" tabindex="-1" id="addShippingTypeModal">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h3 class="modal-title">Shipping Type</h3>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="shippingTypeAddForm">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="name">Shipping Type</label>
                                                                ...
                                                                <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="saveShippingType">
                                            ...
                                            <div class="modal fade" tabindex="-1" id="updateShippingTypeModal">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h3 class="modal-title">Shipping Type</h3>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="shippingTypeUpdateForm">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="ename">Shipping Type</label>
                                                                ...
                                                                <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="updateShippingType">
                                                                            <i class="ki-duotone ki-add-folder fs-1"><span class="path1"></span><span class="path2"></span></i>
                                                                            Save changes
                                                                        </a>
                                                                        <a href="#" class="btn btn-active-icon-dark btn-text-dark"  data-bs-dismiss="modal">
                                        ...
                                        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                            ...
                                            <div class="p-0">
                                                <div class="pt-5 pb-10">
                                                    <table id="shippingTypeTable" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                        <thead>
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#shippingTypeTable').DataTable({
                responsive: true,
                "ajax": {
                    "url": "code-shipping-type.php",
                    "type": "POST",
                    ...
                    { "data": "shipping_type" },
                    {
                        ...
                        "render": function(data, type, full, meta) {
                                ...
                                if (<?php echo $can_edit || $can_add_edit || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-primary btn-text-primary editShippingType" data-id="${data.shipping_type_id}"><i class="ki-duotone ki-notepad-edit fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                                ...
                                if (<?php echo $can_delete || $can_add_delete || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-danger btn-text-danger deleteShippingType" data-id="${data.shipping_type_id}"><i class="ki-duotone ki-delete-folder fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                ...
                $("#saveShippingType").click(function() {
                    $.post("code-shipping-type.php", $("#shippingTypeAddForm").serialize() + '&action=insert', function(response) {
                        ...
                        Swal.fire({
                            ...
                            // Close the modal
                            $('#addShippingTypeModal').modal('hide');
                            // Clear the form fields
                            $('#shippingTypeAddForm')[0].reset();
                            table.ajax.reload();
                        });
                    });
                });
                ...
                // Edit Location
                $('#shippingTypeTable tbody').on('click', '.editShippingType', function() {
                    var shipping_type_id = $(this).data("id");
                    $.post("code-shipping-type.php", { action: 'edit', shipping_type_id: shipping_type_id }, function(data) {
                        // Populate modal with location data for editing
                        $('#updateShippingTypeModal').modal('show');
                        $('#eid').val(data.shipping_type_id);
                        $('#eshipping_type').val(data.shipping_type);
                    }, 'json');
                });

                // Update Location
                $("#updateShippingType").click(function() {
                    $.post("code-shipping-type.php", $("#shippingTypeUpdateForm").serialize() + '&action=update', function(response) {
                        ...
                        Swal.fire({
                            ...
                            // Close the modal
                            $('#updateShippingTypeModal').modal('hide');
                            // Clear the form fields
                            table.ajax.reload();
                        });
                    });
                ...
                // Delete Agent
                $('#shippingTypeTable tbody').on('click', '.deleteShippingType', function() {
                    var shipping_type_id = $(this).data("id");
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.post("code-shipping-type.php", { action: 'delete', shipping_type_id: shipping_type_id }, function(response) {
                                Swal.fire(
                                    'Deleted!',
