                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="login_form">
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Email" name="das_email" autocomplete="off" class="form-control bg-transparent"/> 
                                    <!--end::Email-->
                                </div>
                                ...
                                <div class="fv-row mb-3">    
                                    <!--begin::Password-->
                                    <input type="password" placeholder="Password" name="das_pass" autocomplete="off" class="form-control bg-transparent"/>
                                    <!--end::Password-->
                                </div>
                                <!--end::Wrapper-->    
                                ...
                                <div class="d-grid mb-10">
                                    <button type="submit" id="loginBtn" class="btn btn-primary" value="sub_delivery_agent">
        ...
        <script>
            $(document).ready(function(){
                $('#login_form').submit(function(event){
                    ...
                    // AJAX request
                    $.ajax({
                        url: 'code-sda-login.php', // PHP script for handling login
                        type: 'POST',
                        data: formData,
                        beforeSend: function(){
                        ...
                        success: function(response){
                            if(response == 'success'){
                                ...
                                if(role === 'sub_delivery_agent') {
                                    window.location.href = '<?php echo $url; ?>sub-agent-dashboard.php'; // Redirect customer to cindex.php
                                }
                            } else {
                ...
                $('#loginBtn').click(function() {
                    $('#loginBtn').data('role', 'sub_delivery_agent');
                });
            });
