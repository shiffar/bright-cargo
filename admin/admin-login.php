...
<script src="<?php echo $url; ?>assets/plugins/global/plugins.bundle.js"></script>
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="login_form">
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Email" name="sa_email" autocomplete="off" class="form-control bg-transparent"/> 
                                    <!--end::Email-->
                                </div>
                                ...
                                <div class="fv-row mb-3">    
                                    <!--begin::Password-->
                                    <input type="password" placeholder="Password" name="sa_pass" autocomplete="off" class="form-control bg-transparent"/>
                                    <!--end::Password-->
                                </div>
                                <!--end::Wrapper-->    
                                ...
                                <div class="d-grid mb-10">
                                    <button type="submit" id="loginBtn" class="btn btn-primary" value="super_admin">
    ...
    $('#login_form').submit(function(event){
        ...
        var email = formData.get('sa_email');
        var password = formData.get('sa_pass');
        ...
        // AJAX request
        $.ajax({
            url: 'code-sa-login.php', // PHP script for handling login
            type: 'POST',
            data: formData,
    ...
    // Set role when login button is clicked
    $('#loginBtn').click(function() {
        $('#loginBtn').data('role', 'super_admin');
    });
});
