<?php $title = 'account'; // Default title?>
<!DOCTYPE html>
...
if(isset($_SESSION['auth_user'])) {
    ...
    $can_add = in_array('account_add', $account_permissions);

    // Check if user has edit permission
    $can_edit = in_array('account_edit', $account_permissions);

    // Check if user has delete permission
    $can_delete = in_array('account_delete', $account_permissions);

    // Check if user has add and delete permissions combined
    $can_add_delete = in_array('account_add,account_delete', $account_permissions);

    // Check if user has add and edit permissions combined
    $can_add_edit = in_array('account_add,account_edit', $account_permissions);

    // Check if user has edit and delete permissions combined
    $can_edit_delete = in_array('account_edit,account_delete', $account_permissions);

    // Check if user has add,edit and delete permissions combined
    $can_add_edit_delete = in_array('account_add,account_edit,account_delete', $account_permissions);

    $access_denied = in_array('account_access_denied', $account_permissions);
} else {
                                            ...
                                            <script>
                                                <?php if(!$access_denied): ?>
                                                    ...
                                                    <?php if ($can_add || $can_add_delete || $can_add_edit || $can_add_edit_delete ) : ?>
                                                        document.write('<a href="#"class="btn btn-icon btn-active-color-primary flex-shrink-0 bg-body w-40px h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#addAccountModal"><i class="ki-duotone ki-abstract-10 fs-1"><span class="path1"></span><span class="path2"></span></i></a>');
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </script>

                                            <div class="modal fade" tabindex="-1" id="addAccountModal">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="accountAddForm">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="type" name="type" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="bank_name">Bank Name</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="bank_name" name="bank_name" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="account_number">Account Number</label>
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="account_number" name="account_number" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="saveAccount">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="etype" name="etype" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="bank_name">Bank Name</label>
                                                                            <input type="text" class="form-control" id="ebank_name" name="ebank_name" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="account_number">Account Number</label>
                                                                            <input type="text" class="form-control" id="eaccount_number" name="eaccount_number" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="updateAccount">
                                                                            <i class="ki-duotone ki-add-folder fs-1"><span class="path1"></span><span class="path2"></span></i>
                                                                            Save changes
                                                                        </a>
                                                                        <a href="#" class="btn btn-active-icon-dark btn-text-dark"  data-bs-dismiss="modal">
                                        ...
                                        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                            ...
                                            <div class="p-0">
                                                <div class="pt-5 pb-10">
                                                    <table id="accountTable" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                        <thead>
                                                            <tr class="fw-bold fs-6 text-gray-800 px-7">
                                                            <th class="min-w-150px">Type</th>
                                                            <th class="min-w-150px">Banke name</th>
        ...
        <script>
            $(document).ready(function() {
                    ...
                    { "data": "status" },
                    {
                        ...
                        "render": function(data, type, full, meta) {
                                ...
                                if (<?php echo $can_edit || $can_add_edit || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-primary btn-text-primary editAccount" data-id="${data.account_id}"><i class="ki-duotone ki-notepad-edit fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                                ...
                                if (<?php echo $can_delete || $can_add_delete || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-danger btn-text-danger deleteAccount" data-id="${data.account_id}"><i class="ki-duotone ki-delete-folder fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                ...
                $("#saveAccount").click(function() {
                    $.post("code-account.php", $("#accountAddForm").serialize() + '&action=insert', function(response) {
                ...
                // Edit Account
                $('#accountTable tbody').on('click', '.editAccount', function() {
                    var account_id = $(this).data("id");
                    $.post("code-account.php", { action: 'edit', account_id: account_id }, function(data) {
                        // Populate modal with account data for editing
                        // For example:
                        $('#updateAccountModal').modal('show');
                        $('#eid').val(data.account_id);
                        $('#etype').val(data.type);
                        $('#ebank_name').val(data.bank_name);
                        $('#eaccount_number').val(data.account_number);
                ...
                $("#updateAccount").click(function() {
                    $.post("code-account.php", $("#accountUpdateForm").serialize() + '&action=update', function(response) {
                ...
                // Delete Agent
                $('#accountTable tbody').on('click', '.deleteAccount', function() {
                    var account_id = $(this).data("id");
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.post("code-account.php", { action: 'delete', account_id: account_id }, function(response) {
                                Swal.fire(
                                    'Deleted!',
