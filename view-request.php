<?php $title = 'request'; // Default title?>
<!DOCTYPE html>
                                        ...
                                        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                            ...
                                            <div class="p-0">
                                                <div class="pt-5 pb-10">
                                                    <table id="requestTable" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                        <thead>
                                                            <tr class="fw-bold fs-6 text-gray-800 px-7">
                                                            <th class="min-w-150px">HBL Code</th>
                                                            <th class="min-w-150px">Current status</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                        </tbody>
    ...
    columns: [
        ...
        { data: "current_status" },
        {
                        ...
                        "render": function(data, type, full, meta) {
                            return `<a href="#" class="btn btn-active-icon-primary btn-text-primary editNotification" data-id="${data.hbl_status_id}"><i class="ki-duotone ki-double-check fs-2qx"><span class="path1"></span><span class="path2"></span></i></a>
...
$(document).on('click', '.editNotification', function() {
    var notificationId = $(this).data('id'); // Corrected

    // Send AJAX request to update the notification status
    $.ajax({
        url: 'code-request.php',
        type: 'POST',
        data: { action: 'update2', notificationId: notificationId },
        dataType: 'json',
