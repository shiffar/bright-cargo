    ...
    <body  id="kt_body"  class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat" >
                                                                     ...
                                                                     <div class="nav-group nav-group-fluid">
                                                                        ...
                                                                        <label>
                                                                            <input type="radio" class="btn-check"
                                                                                name="type" id="adminBtn" value="admin"/>
                                                                            <span
                                                                        ...
                                                                        <label>
                                                                            <input type="radio" class="btn-check"
                                                                                name="type" id="employeeBtn" value="employee" />
                                                                            <span
                                                                                class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">
                                                                                Employee
                                                                            </span>
                                                                        ...
                                                                        <label>
                                                                            <input type="radio" class="btn-check"
                                                                                name="type" id="customerBtn" value="customer" />
                                                                            <span
                                                                                class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">
                                                                                Customer
                                                                            </span>
        ...
        <script>
            $(document).ready(function(){
                    ...
                    $.ajax({
                        ...
                        success: function(response){
                            if(response == 'success'){
                                ...
                                if(role === 'admin') {
                                    window.location.href = '<?php echo $url; ?>index'; // Redirect admin to index.php
                                } else if(role === 'employee') {
                                    // Redirect employee to a specific page (replace 'employee.php' with the desired page)
                                    window.location.href = '<?php echo $url; ?>index';
                                } else if(role === 'customer') {
                                    window.location.href = '<?php echo $url; ?>cindex'; // Redirect customer to cindex.php
                                }
                            } else {
                ...
                // Handle click events for role buttons
                $('#adminBtn').click(function() {
                    $('#loginBtn').data('role', 'admin');
                });

                $('#employeeBtn').click(function() {
                    $('#loginBtn').data('role', 'employee');
                });
