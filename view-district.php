                ...
                <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                    ...
                    <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                        ...
                        ?>      
                                            <script>
                                                <?php if(!$access_denied): ?>
                                                    ...
                                                    <?php if ($can_add || $can_add_delete || $can_add_edit || $can_add_edit_delete ) : ?>
                                                        document.write('<a href="#"class="btn btn-icon btn-active-color-primary flex-shrink-0 bg-body w-40px h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#addDistrictModal"><i class="ki-duotone ki-abstract-10 fs-1"><span class="path1"></span><span class="path2"></span></i></a>');
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </script>
                                            

                                            <div class="modal fade" tabindex="-1" id="addDistrictModal">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="districtAddForm">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="district" name="district" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="saveDistrict">
                                            ...
                                            <div class="modal fade" tabindex="-1" id="updateDistrictModal">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="districtUpdateForm">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-lg form-control-solid" id="edistrict" name="edistrict" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="modal-footer">
                                                                        <a href="#" class="btn btn-active-icon-primary btn-text-primary" id="updateDistrict">
                                                                            <i class="ki-duotone ki-add-folder fs-1"><span class="path1"></span><span class="path2"></span></i>
                                                                            Save changes
                                                                        </a>
                                                                        <a href="#" class="btn btn-active-icon-dark btn-text-dark"  data-bs-dismiss="modal">
                                        ...
                                        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                            ...
                                            <div class="p-0">
                                                <div class="pt-5 pb-10">
                                                    <table id="districtTable" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                        <thead>
        ...
        <script>
            $(document).ready(function() {
                    ...
                    { "data": "country" },
                    {
                        ...
                        "render": function(data, type, full, meta) {
                                ...
                                if (<?php echo $can_edit || $can_add_edit || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-primary btn-text-primary editDistrict" data-id="${data.district_location_id}"><i class="ki-duotone ki-notepad-edit fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                                ...
                                if (<?php echo $can_delete || $can_add_delete || $can_edit_delete || $can_add_edit_delete ? 'true' : 'false'; ?>) {
                                    buttons += `<a href="#" class="btn btn-active-icon-danger btn-text-danger deleteLocation" data-id="${data.district_location_id}"><i class="ki-duotone ki-delete-folder fs-1"><span class="path1"></span><span class="path2"></span></i></a>`;
                                }
                ...
                $("#saveDistrict").click(function() {
                    $.post("code-district.php", $("#districtAddForm").serialize() + '&action=insert', function(response) {
                ...
                // Edit Location
                $('#districtTable tbody').on('click', '.editDistrict', function() {
                    var district_location_id = $(this).data("id");
                    $.post("code-district.php", { action: 'edit', district_location_id: district_location_id }, function(data) {
                        // Populate modal with location data for editing
                        $('#updateDistrictModal').modal('show');
                        $('#eid').val(data.district_location_id);
                ...
                $("#updateDistrict").click(function() {
                    $.post("code-district.php", $("#districtUpdateForm").serialize() + '&action=update', function(response) {
                ...
                // Delete Agent
                $('#districtTable tbody').on('click', '.deleteDistrict', function() {
                    var district_location_id = $(this).data("id");
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.post("code-district.php", { action: 'delete', district_location_id: district_location_id }, function(response) {
                                Swal.fire(
                                    'Deleted!',
